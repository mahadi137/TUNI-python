"""
Draws a rectangle as defined by the user. The inputs are assumed
to be valid, that is, the width and height are always greater than
or equal to three characters.
"""
